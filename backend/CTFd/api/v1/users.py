...
class UserList(Resource):
    ...
    def get(self, query_args):
        ...
        team_id = query_args.pop("team_id", None)
...
class UserPublic(Resource):
    ...
    def get(self, user_id):
        ...
        if getattr(user, "team_id", None) and getattr(user, "team", None):
            response.data["team_name"] = user.team.name
        else:
            response.data["team_name"] = None
...
class UserPrivate(Resource):
    ...
    def get(self):
        ...
        dumped = UserSchema("self").dump(user).data
        response = dict(dumped) if dumped else {}
